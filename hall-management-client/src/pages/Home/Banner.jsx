...
const Banner = () => {
    return (
        <div className=" flex justify-center items-center lg:p-20 bg-base-200">
            ...
            initial={{ y: 50, opacity: 0}} // Start slightly below and fully transparent
            animate={{ y: 0, opacity: 1 }}  // Move to the original position and become fully visible
            transition={{ duration: 1, delay: 0, ease: "easeOut" }} // Animation settings
...
<motion.img
    ...
    transition={{ duration: 2, delay: 0, ease: "easeOut" }} // Delay the second animation
...
<h1 className="text-6xl font-bold text-gray-900 mb-6">
    ...
    <Link to='/login'><button className="btn btn-primary bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-all duration-300">
        Get Started
    </button></Link>
